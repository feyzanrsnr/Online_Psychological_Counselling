    ...
    <section id='options' className='section'>
        ...
        <div className='options' >
            ...
            <div className='option' >
                <img className='image' src={icon1} width={150} alt="icon" />
            ...
            <Link to="/expert">
            <div className='option' >
                <img className='image' src={icon2} width={150} alt="icon" />
                <p>
                    UZMANIMI BUL
                </p>
            </div>
            ...
            <div className='option' >
                <img className='image' src={icon3} width={150} alt="icon" />
                <p>
                    BİLGİ AL
                </p>
            </div>
            ...
            <Link to="/question">
            <div className='option' >
                <img className='image' src={icon4} width={150} alt="icon" />
                <p>
                    SORU SOR
                </p>
            </div>
